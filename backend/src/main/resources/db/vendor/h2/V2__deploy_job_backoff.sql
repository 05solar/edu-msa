-- V2 · 배포 큐 재시도 백오프 + 상태 인덱스 (H2 테스트 동판 — 운영 MariaDB 용은 db/vendor/mariadb/V2)
...
alter table deploy_jobs add column if not exists next_attempt_at timestamp(6) with time zone;
